...
{
    public class Brand : AuditableModelBase, IAggregateRoot
    {
        ...
        private Brand(string name, long userId)
        {
            Name = Guard.Against.Null(name, nameof(name));
            Audit(userId, true);
        }

        public static Brand Create(string name, long userId) => new(name, userId);
